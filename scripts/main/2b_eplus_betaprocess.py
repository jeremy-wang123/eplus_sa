...
base_output_idf_dir = os.path.join(work_dir, "randomized_idfs_beta") # change base output to beta sequence generated
weather_file = os.path.join(
    work_dir, "weather_data",
    "USA_IL_Chicago-OHare-Intl-AP.725300_AMY_2023.epw"
)
base_output_sim_dir = os.path.join(work_dir, "output_beta") # output_beta stores values
...
# mpirun -hostfile myhosts -np 225 /jumbo/keller-lab/Applications/mambaforge/envs/eplus/bin/python 2b_eplus_betaprocess.py